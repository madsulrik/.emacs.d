...
I'll say it: modern Emacs Lisp is unfairly maligned. However, it was pretty fairly maligned before Emacs 24, which introduced lexical
scoping. For reasons of compatibility, it's not on by default, and the documentation states that "unlike other file-local variables,
this must be set in the first line of a file."
...
Now it is time to setup Org-agenda
...
applications. This enables it to be much faster than term-mode and to also provide a complete terminal emulation experience.
...
*** Write good
This is a minor mode to aid in finding common writing problems. Matt Might’s weasel-words scripts inspired this mode.
